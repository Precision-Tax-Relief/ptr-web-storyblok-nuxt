...
<template>
  <div>
    ...
    <div v-if="showPopup" class="fixed inset-0 z-50 flex items-center justify-center p-0" @click="closePopup">
      <div class="w-md relative max-w-md" @click.stop>
        <!-- Close Button -->
        <div class="absolute -top-10 right-0 z-50">
          <button
            type="button"
            class="flex rounded-md bg-white text-gray-400 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-primaryDark focus:ring-offset-2"
            @click="closePopup"
          >
