...
defineProps({
  title: {
    type: String,
    required: true,
    default: "Key Questions When Selecting a Tax Relief Company"
  },
  subtitle: {
    type: String,
    default:
      ...
      >
        <div class="content">
          ...
          >
            ...
            <h3 :id="`tab-${index}`" class="font-bold md:text-3xl text-[1.6rem] leading-normal text-primary text-left">
              {{ item.question }}
            </h3>
          </HeadlessDisclosureButton>
