...
<template>
  <div class="relative isolate flex min-h-screen flex-col overflow-hidden bg-neutral-900 pt-14 lg:flex-col-reverse">
    <video autoplay loop playsinline muted class="absolute inset-0 z-0 h-full w-full object-cover brightness-75">
    ...
    <div
      class="relative z-20 m-12 max-w-3xl rounded-xl bg-gradient-to-r from-charcoal-600/90 to-charcoal-600/40 p-12 sm:my-24 sm:ml-16 lg:my-40 lg:ml-28"
    >
