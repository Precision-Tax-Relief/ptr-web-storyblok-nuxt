...
<template>
  <Popover class="relative">
    <PopoverButton
        :class="[
        'flex items-center gap-x-1 rounded p-1.5 font-semibold leading-6',
        style
      ]"
    >
      <slot name="link"/>
    ...
    >
      <PopoverPanel
          class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5 bg-gray-50"
      >
        <slot name="panel"/>
      </PopoverPanel>
    </transition>
