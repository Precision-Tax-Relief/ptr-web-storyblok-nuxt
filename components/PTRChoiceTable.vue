      ...
      <table class="w-full text-center">
        <thead class="text-sm text-white">
          <tr>
            ...
            <th class="w-1/3 border-e border-white bg-[#4A924D] p-2 text-sm font-semibold">PRECISION TAX</th>
            <th class="w-1/3 border-e border-white bg-gray-600 p-2 text-sm font-semibold">
    ...
    <div v-else class="border-b-2 pb-1">
      <table class="w-full text-center">
        <thead class="text-md text-white">
          <tr>
            <th class="text-md border-e border-white bg-[#77A6E9] p-3 text-left font-semibold uppercase">
              <span class="flex items-center gap-2">
                <Icon name="material-symbols-light:verified-outline" class="h-8 w-8" />
                <span>The Choice is Clear</span>
              </span>
            </th>
            <th class="text-md border-e border-white bg-[#4A924D] p-3 font-semibold">PRECISION TAX RELIEF</th>
            <th
              v-for="(data, key) in competitors"
              :key="key"
              class="text-md border-e border-white bg-gray-600 p-3 font-semibold"
            >
              {{ data.name }}
            </th>
          </tr>
