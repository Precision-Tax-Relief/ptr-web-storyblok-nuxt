<template>
  <header class="bg-primary py-2 text-left leading-6 text-white lg:block lg:py-3 z-50">
    <div class="container px-4 sm:px-6 lg:px-8">
      <div class="flex flex-row justify-between text-left leading-6 text-white items-center">
        <div class="flex items-center space-x-8">
          ...
          <div class="flex flex-col">
            <div class="align-super text-xl font-bold text-white">
            ...
            <div class="text-xl font-bold text-white">Recommends Precision&nbsp;Tax&nbsp;Relief</div>
          </div>
        </div>
