  ...
  >
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div
        ...
        class="flex flex-row items-center justify-between text-left leading-6 text-white"
      >
        <div class="flex items-center space-x-8">
          <strong class="logo">
            <a href="#" data-click-name="ClickHdr - Logo">
              <svg xmlns="http://www.w3.org/2000/svg" fill="white" width="70" height="70" viewBox="0.5 0.5 266.4 368.6">
          ...
          <div class="flex flex-col">
            <div class="align-super text-2xl font-bold text-white">
              <span class="hidden sm:inline">Better Business Bureau</span> <span class="inline sm:hidden">BBB</span>
              <span class="-ml-2 align-super text-sm">®</span>
            </div>
            <div class="text-xl font-bold text-white lg:text-2xl">Recommends Precision&nbsp;Tax&nbsp;Relief</div>
          </div>
        </div>
