  ...
  <div v-editable="props.blok" class="bg-slate-100 md:py-28 py-20">
    <div class="container mx-auto">
      <div class="section-head">
        <h2
          class="lg:mb-12 mb-10 text-4xl lg:text-[4.1rem] font-bold text-primary text-center max-w-5xl mx-auto leading-tight"
        >
          Discover Why Precision Tax Earns Top BBB Endorsement
        </h2>
      </div>
      <ul
        class="brand-list justify-between flex flex-row flex-wrap items-center gap-8 sm:gap-4 lg:gap-8 md:max-w-md lg:max-w-5xl mx-10 md:mx-auto mb-16 lg:mt-16"
      >
        <li>
          <div class="w-36">
            ...
            <NuxtPicture
              ...
              :alt="blok.googleImg?.alt"
              loading="lazy"
            />
            <div class="underline text-[#9b9b9b] text-center mt-2 text-lg lg:text-2xl">
              <a id="open-google-modal" href="#modal-google" data-modal-open="" data-click-name="ClickG2 - Google Modal"
        ...
        <li>
          <div class="flex flex-col items-center">
            <svg class="w-full mx-auto" viewBox="0 0 1785 448">
              <path
                ...
                fill-rule="nonzero"
              ></path>
              <path fill="none" d="M-.003 0h1784.795v447.53H-.003z"></path>
              <path
              ...
              ></path>
              <path
                d="M307.17 293.328l-11.273-35.008-81.288 59.038 92.562-24.03z"
                fill="#005128"
                fill-rule="nonzero"
              ></path>
            </svg>
            <div class="flex flex-col items-center gap-3">
              ...
              <img
                class="lg:w-[178px] w-[150px] h-auto m-0"
        ...
        <li class="mt-10 lg:mt-0 mx-auto lg:mx-0">
          <div class="badge lg:w-[180px] badge_investopedia">
            <span class="investopedia__holder">
              <svg class="mx-auto" viewbox="0 0 574.04 89.64">
                <path fill="#323a56" d="M33.6 24.8l6.33 4-2.42 22.87L71.57 30.9a36 36 0 10-70.5 13.77z"></path>
                <path fill="#323a56" d="M34.64 63.21l-6.33-4 2.42-22.86L4.09 52.61a36 36 0 0067.53-12z"></path>
                <circle fill="#f64e00" cx="37.81" cy="16.42" r="5.09"></circle>
                <path
                  fill="#201d1e"
            ...
            <div class="underline text-[#9b9b9b] text-center text-lg lg:text-2xl">
              <a
