  ...
  <div v-editable="props.blok" class="bg-slate-100 px-4 py-20 lg:px-0">
    <div class="container px-0 sm:px-4">
      <div class="mx-auto max-w-3xl">
        <h2
          class="mx-auto mb-10 max-w-5xl text-center text-2xl font-bold leading-tight text-black text-primary sm:text-3xl md:text-4xl lg:text-4xl"
        >
      ...
      <div class="my-20">
        <h3 class="mb-8 px-4 text-center text-2xl font-bold text-primary md:text-4xl lg:text-4xl">
